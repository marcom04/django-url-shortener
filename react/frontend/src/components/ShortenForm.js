...
import {Container, Form, Button, InputGroup, Toast, ToastContainer} from 'react-bootstrap';
                    ...
                    <Form onSubmit={this.createMapping}>
                        ...
                        <Form.Group className="mb-3" hidden={this.state.short_url_hidden}>
                            <Form.Label htmlFor="short_url">
                                Here's your shortened URL, valid
                                until: {format(this.state.expiry_date, 'yyyy/MM/dd HH:mm')}
                            </Form.Label>
